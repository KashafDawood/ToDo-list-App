export const closeTaskEditorBtn = document.querySelector(".closeIcon");
export const TaskEditorContainer = document.querySelector(".taskCustomizerContainer");
...
export const saveTaskBtn = document.querySelector(".btn--save")
